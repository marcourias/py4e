...
## above 40 hours. Put the logic to do the computation of pay in a function called computepay() and use the function
...
def computepay(h, r):
    ...
    if h <= 40:
        ...
        normalhrs = 40 * r
        extrahrs = ((h-40)*1.5*r)
        totalhrs = normalhrs + extrahrs
    
    #print(f'Normal hours: {normalhrs}')
    #print(f'Extra hours: {extrahrs}')
